...
?>
	...
	<div class="rightshade"></div>
   	<div class="container">
		...
		<a href="<?php echo BASE_URL?>/admin/Global_Settings">
		...
		<a href="<?php echo BASE_URL?>/admin/add_generators">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
		    <div class="options">
                        <img src="../images/profile.png" alt="sites">
                        <span class="profile_options">Add New Generator</span>
                    </div>
                </div>
		</a>
		<a href="<?php echo BASE_URL?>/admin/editExsisting_generators">
	        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
		    <div class="options">
			<img src="../images/reporting.png" alt="reporting">
			<span class="profile_options">Edit Existing Generator</span>
		    </div>
		</div>
		</a>
		<a href="<?php echo BASE_URL?>/admin/suspendedAccount">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
		    <div class="options">
