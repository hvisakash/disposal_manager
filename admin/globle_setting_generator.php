...
require_once("../init.php");
    ...
    $list=$generator->show_global_setting_free_record($_REQUEST['id'],$session->__get("user_id"));
   //show globle setting record for elite account
    $elite_list=$generator->show_global_setting_elite_record($_REQUEST['id'],$session->__get("user_id"));
	...
	$array = array(
	    ...
	    $generator->update_global_setting_free_record($array,$_REQUEST['id']);
	}
	...
	$array = array(
	    ...
	    $generator->update_global_setting_elite_record($array,$_REQUEST['id']);
	}
