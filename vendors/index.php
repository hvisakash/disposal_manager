...
?>
	...
	<div class="rightshade"></div>
   	<div class="container">
		...
		<a href="<?php echo BASE_URL?>/vendors/userprofile">
		...
		<a href="<?php echo BASE_URL?>/vendors/Sites">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
		    <div class="options">
		...
		<!--<a href="<?php //echo BASE_URL?>/admin/globle_setting">-->
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
		    <div class="options">
			<img src="../images/setting.png" alt="setting">
			<span class="profile_options">Service Settings</span>
		    </div>
		</div>
		</a>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
	       ...
	       <!--<a href="<?php //echo BASE_URL?>/admin/help">-->
	        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
               ...
               <a href="<?php echo BASE_URL?>/vendors/help">
	        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
                    	<div class="options">
