...
$admin->edit_existing_sites($array);
}
...
<div class="banner bannerwithnoimg">
		...
		<tbody class="last_login">
		    ...
		    ?>
		    <tr>
			<td><a href="<?php echo BASE_URL;?>/admin/View_sites/<?php echo $site_name['id'];?>"><?php echo $site_name['sitename']?></a></td>
            <td><a href="#link1" id="<?php echo $site_name['id'];?>" title="Edit" class="link select_site_id" data-toggle="modal">Edit</a></td>
		    <?php
		    }
		    ?>
		</tbody>
        ...
        <!-------Sites REcord END ----->
                    ...
                    <!----    <div align="center">
                        <input type="submit" name="getPDF" value="getPDF" class="btn btn-success"/>
                        </div>----
                        <br/><br/><br/>-->
...
$(document).ready(function(){
  $(".select_site_id").click(function(e)
  { 
    select_site_id=this.id;
    var info = 'select_site_id=' + select_site_id;
    $.ajax({
	  type: "POST",
	  url: "ajaxcalling.php",
	  data: info,
