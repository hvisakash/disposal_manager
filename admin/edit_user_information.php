...
require_once("../init.php");
	...
	$array = array(
	    ...
	    $res=$admin->update_admin_record($array,$session->__get("user_id"),$session->__get("firstname"));
	if($res==1)
	    {
	      $mail = Mail::getInstance();
	      $mail->admin_profile_update($_POST['email']);
	      $redirect->redirect("".BASE_URL."/admin/user_profile.php");
	    }
	   }
