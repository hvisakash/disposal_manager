...
function myconfirm(ele) {
	...
	id=ele.id;
	//alert();
	var con=confirm("Are you sure you want to resume services with this vendor?");
	if ( con== true) {
	...
	var info = 'v_unban=' + id;
		$.ajax({
            ...
            success: function(msg) {
                alert(" Vendors Successfully Resume ");
...
//Select Banned Vendors from Vendors_ban_tb Table	
	$row=$generators->select_ban_vendors();
...
?>
	<div class="banner bannerwithnoimg">
		...
		<div class="bannertxt col-lg-12">
		    <span class="page_heading">Vendors - Banned</span>
...
-->
		...
		<div class="col-lg-12">
		  ...
		  <table align="center" border="1" id="showdata" class="table table-bordered" vspace="50" hspace="50">
            ...
            <td><?php  echo $record['ban_date'];?></td>
             <td>
