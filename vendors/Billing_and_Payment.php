   	...
   	<div class="container">
    	<div class="row">
        	<div class="col-lg-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
                    	<div class="options">
                            ...
                            <span class="profile_options">Current Payment Method (Last Four Digit)</span>
                        </div>
                    </div>
                    </a>
		    <a href="<?php echo BASE_URL;?>/vendors/Billing_and_Payment">
		    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
                    	<div class="options">
                            <img src="../images/profile.png" alt="profile">
			    <span class="profile_options">PaymentHistory</span>
                        </div>
                    </div>
		   </a>
		    <a href="<?php echo BASE_URL;?>/vendors/Billing_and_Payment">
		    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 optionbox">
                        <div class="options">
                            ...
                            <span class="profile_options">Cancel Subscription</span>
                        </div>
                    </div>
                    </a>
           <div class="clearfix"></div>
